...
export default function Hero() {
  return (
    <section className="bg-[#3B1547] px-6 py-16 sm:py-20 md:py-24 text-center">
      <div className="max-w-3xl mx-auto">
        <h1 className="text-white font-bold text-3xl sm:text-4xl md:text-5xl leading-tight">
          Build Stunning Hotel
        </h1>
        <h2 className="text-purple-300/50 font-bold text-3xl sm:text-4xl md:text-5xl leading-tight mt-1">
          Websites That Fill Rooms
        </h2>

        <p className="text-purple-200/70 text-sm sm:text-base mt-6 max-w-xl mx-auto">
          The all-in-one SaaS platform for hotels, resorts & boutique stays.
          <br className="hidden sm:block" />
          No code. No designers. Just results that matter and drive growth.
        </p>
