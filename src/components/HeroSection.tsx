...
export default function Hero() {
  return (
    <section className="bg-[#3B1547] px-6 py-14 w-full sm:py-20 md:py-24 text-center">
      <div className="max-w-3xl mx-auto w-full">
        ...
        <div className="flex flex-col gap-3 mt-8 max-w-xs mx-auto sm:max-w-none sm:flex-row sm:items-center sm:justify-center">
          <button className="bg-[#FF751F] hover:bg-orange-600 text-[#EDE8EE] text-sm font-medium px-6 py-2 rounded-lg w-full sm:w-auto border border-[#CC5E19]">
            Start 14-Days Free Trial
          </button>
          <Link href={"/schedule-demo"} className="bg-white border border-gray-200 text-[#160818] text-sm font-medium px-6 py-2 rounded-lg w-full sm:w-auto hover:bg-gray-100">
            Book a Demo
          </Link>
        </div>
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center gap-2 sm:gap-6 mt-8 text-purple-200/60 text-xs sm:text-sm">
          <span className="flex items-center text-[#EDE8EE] gap-1.5">
