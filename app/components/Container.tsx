...
//   return (
//     <section className="w-full overflow-hidden  bg-[#3B1547] px-4 sm:px-6  pb-14 sm:pt-2 sm:pb-16">
//       <div
//         className=" flex w-full items-center  lg:max-w-5xl  justify-center rounded-2xl sm:rounded-3xl  bg-cover bg-center bg-no-repeat p-2  sm:p-3"
